            ...
            <table id="sort" class="striped responsive-table materials-left centered">
                <thead class="view-materials-head">
                    <tr class="material-headers">
                        <th onClick="javascript:SortTable(0,'T');">Material Name</th>
                        <th onClick="javascript:SortTable(1,'T');">Category</th>
                        <th onClick="javascript:SortTable(2,'N');">Quantity Remaining</th>
                        <th onClick="javascript:SortTable(3,'T');">Unit</th>
                        <th onClick="javascript:SortTable(4,'N');">Threshold</th>
                        <th onClick="javascript:SortTable(5,'T');">Project</th>
