            ...
            <form action="../server.php" method="POST">
                <div class="row">
                    ...
                    <div class="input-field col s5 account-lastname-field">
                        <input id="account-lastname" name="newlname" type="text" placeholder="<?php echo $row[2]?>">
