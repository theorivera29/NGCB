        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th>Delivered Material as of <?php echo date("M. Y"); ?>
                        <!--DATE MONTH AND YEAR ONLY BACKEND-->
                    </th>
                    <th id="merge-two-cell">Material pulled out as of <?php echo date("M. Y"); ?>
                        <!--DATE MONTH AND YEAR ONLY BACKEND-->
                    </th>
                    <th>Accumulated Materials Delivered</th>
                    <th id="merge-two-cell">Material on site as of <?php echo date("M. Y"); ?>
                        <!--DATE MONTH AND YEAR ONLY BACKEND-->
                    </th>
                    <th>Project</th>
                </tr>
            ...
            <tbody>
                ...
                ?>
                <tr>
                    <td id="merge-ten-cell"> <b><?php echo $categ; ?></b></td>
                </tr>
                <?php 
